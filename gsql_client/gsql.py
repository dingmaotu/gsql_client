...
from .common import quote_plus, urlencode, HAS_SSL, HTTPConnection, HTTPSConnection, \
...
class Client(object):
    ...
    def get_secret(self, graph_name, create_alias=None):
        ...
        if s:
            ...
            lines = self.command("create secret {0}".format(create_alias))
            # The secret: xxxxxxxxxxxxxxxxxxxxxxxxxx has been created for user "tigergraph".
